...
async def startCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[
      InlineKeyboardButton('Beni Sohbetinize Ekle', url=f"https://t.me/{bot.username}?startgroup=true")
      ],[
      InlineKeyboardButton('Yardım', callback_data='main#help'),
      InlineKeyboardButton('Hakkımda', callback_data='main#about')
      ],[
      InlineKeyboardButton('Support', url='t.me/NatroDuyuru')
      ]]
...
async def aboutCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[ InlineKeyboardButton('<Anasayfa', callback_data='main#start'),
                  InlineKeyboardButton('Yardım', callback_data='main#help') ]]
...
async def maincallback(client: FilterBot, message):
    ...
    if type == "start":
        bot = await client.get_me()
        keyboard = [[InlineKeyboardButton('Beni Sohbetinize Ekle', url=f"https://t.me/{bot.username}?startgroup=true")],
        [
            InlineKeyboardButton('Yardım', callback_data='main#help'),
            InlineKeyboardButton('Hakkımda', callback_data='main#about')
        ],
